...
new_te_df=pd.read_csv('test_feature_best/ex_test_13259feature.csv')
...
def test_single_label(test_feature,model_path):
    ...
    submit.to_csv("result/result.csv", index=False)
    return None

test_single_label(new_te_df,'model/best_model')

print('\n','******** test with bestmodel successfully ********','\n')